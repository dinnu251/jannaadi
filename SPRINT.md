...
| ID | Task | Status |
|----|------|--------|
| H-7 | Record 3-min demo video (golden path, app.prasyn.com visible) | ✅ DONE — assets/JanNaadi-demo-track1.mp4, committed b04d8ad |
| H-8 | Verify F11: app.prasyn.com dashboard loads <2s | ✅ DONE — verified 13 Jul 2026 |
...
| 3-min video (golden path) | ✅ assets/JanNaadi-demo-track1.mp4 |
...
Human (still open):
  H-10: Confirm hack2skill Team Dashboard fields ← LAST REMAINING

Completed 13 Jul:
  H-7: Demo video committed (b04d8ad)
  H-8: F11 perf verified < 2s at app.prasyn.com
  SUBMISSION.md: video link + F11 evidence added
```
