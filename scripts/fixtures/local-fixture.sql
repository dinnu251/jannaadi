...
('11111111-1111-1111-1111-111111111111', 'Drainage overflow — Pedagantyada (Gajuwaka)', 'drainage', 'Ward 75 - Pedagantyada',
...
('22222222-2222-2222-2222-222222222222', 'Potholes on MVP main road', 'roads', 'Ward 19 - MVP Sector-12',
...
('33333333-3333-3333-3333-333333333333', 'Irregular water supply Madhurawada', 'water', 'Ward 25 - Madhura Nagar',
...
SELECT ('a1a1a1a1-0000-0000-0000-00000000000' || i)::uuid, 'processed', 'text', 'te',
       'డ్రైనేజీ సమస్య ' || i, 'drainage', 'Ward 75 - Pedagantyada', 4 + (i % 2),
...
SELECT ('b2b2b2b2-0000-0000-0000-00000000000' || i)::uuid, 'processed', 'text', 'mixed',
       'Road gunta ' || i, 'roads', 'Ward 19 - MVP Sector-12', 3,
...
SELECT ('c3c3c3c3-0000-0000-0000-00000000000' || i)::uuid, 'processed', 'voice', 'hi',
       NULL, 'water', 'Ward 25 - Madhura Nagar', 2,
...
('eeee0000-0000-0000-0000-000000000001', 'received', 'text', 'te', 'పెండుర్తి లో రోడ్డు బాగోలేదు', 'Ward 96 - Pendurthi old Village', now(), true);
